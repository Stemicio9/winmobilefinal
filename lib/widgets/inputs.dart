...
class InputWidget extends StatelessWidget {
  ...
  InputWidget({@required hinttext,@required controller, this.ispassword = false ,validator = defaultvalidator, this.labeltext = "", this.onchanged = funzionecostante, this.autofocus = false, this.keyboard = TextInputType.text })
